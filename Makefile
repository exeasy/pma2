...
bin_PROGRAMS = bm$(EXEEXT) pem$(EXEEXT) icm$(EXEEXT) dbm$(EXEEXT) \
	qconf$(EXEEXT)
subdir = .
...
bm_DEPENDENCIES = ./comm/libpmacomm.a ./conf/libpmaconf.a \
	...
	./timer/libpmatimer.a ./snmp/libsnmpapi.a \
	./logger/libploggersrv.a ./logger/libplogger.a ./lib/libpma.a \
	./reg/libpmareg.a ./vty/libpmavty.a
AM_V_lt = $(am__v_lt_$(V))
...
icm_DEPENDENCIES = ./server/libpmaicm.a ./router/libpmarouter.a \
	./lsd/libpmalsd.a ./lsdb/libpmalsdb.a \
...
am__v_CCLD_1 = 
SOURCES = $(bm_SOURCES) $(dbm_SOURCES) $(icm_SOURCES) $(pem_SOURCES) \
	$(qconf_SOURCES)
DIST_SOURCES = $(bm_SOURCES) $(dbm_SOURCES) $(icm_SOURCES) \
	$(pem_SOURCES) $(qconf_SOURCES)
...
qconf$(EXEEXT): $(qconf_OBJECTS) $(qconf_DEPENDENCIES) $(EXTRA_qconf_DEPENDENCIES) 
	@rm -f qconf$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(qconf_OBJECTS) $(qconf_LDADD) $(LIBS)
